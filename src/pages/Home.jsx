                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6 w-full animate-in slide-in-from-bottom-8 fade-in duration-1000 delay-200">
                    ...
                    <Link to="/chapter" className="group flex flex-col bg-white border border-sand-tertiary rounded-xl overflow-hidden hover:shadow-xl hover:shadow-gold-primary/5 transition-all duration-300">
                        <div className="h-28 md:h-36 overflow-hidden relative">
                            ...
                            <div className="absolute bottom-3 left-4 md:left-6">
                                <span className="bg-sand-secondary border border-sand-tertiary text-charcoal-main text-[9px] font-bold px-2 py-1 rounded uppercase tracking-widest">Part I</span>
                            </div>
                        </div>
                        <div className="p-5 md:p-6 flex flex-col flex-1 bg-sand-primary">
                            <h3 className="serif-title text-lg md:text-xl mb-2 text-charcoal-main">Chikhai Bardo</h3>
                            <p className="text-charcoal-muted text-xs leading-relaxed mb-4 md:mb-6 flex-1 font-serif line-clamp-2 md:line-clamp-none">
                    ...
                    <Link to="/chapter" className="group flex flex-col bg-white border border-sand-tertiary rounded-xl overflow-hidden hover:shadow-xl hover:shadow-gold-primary/5 transition-all duration-300">
                        <div className="h-28 md:h-36 overflow-hidden relative">
                            ...
                            <div className="absolute inset-0 bg-gradient-to-t from-white to-transparent" />
                            <div className="absolute bottom-3 left-4 md:left-6">
                                <span className="bg-sand-secondary border border-sand-tertiary text-charcoal-main text-[9px] font-bold px-2 py-1 rounded uppercase tracking-widest">Part II</span>
                            </div>
                        </div>
                        <div className="p-5 md:p-6 flex flex-col flex-1 bg-sand-primary">
                            <h3 className="serif-title text-lg md:text-xl mb-2 text-charcoal-main">Chonyid Bardo</h3>
                            <p className="text-charcoal-muted text-xs leading-relaxed mb-4 md:mb-6 flex-1 font-serif line-clamp-2 md:line-clamp-none">
                    ...
                    <Link to="/chapter" className="group flex flex-col bg-white border border-sand-tertiary rounded-xl overflow-hidden hover:shadow-xl hover:shadow-gold-primary/5 transition-all duration-300">
                        <div className="h-28 md:h-36 overflow-hidden relative">
                            ...
                            <div className="absolute inset-0 bg-gradient-to-t from-white to-transparent" />
                            <div className="absolute bottom-3 left-4 md:left-6">
                                <span className="bg-sand-secondary border border-sand-tertiary text-charcoal-main text-[9px] font-bold px-2 py-1 rounded uppercase tracking-widest">Part III</span>
                            </div>
                        </div>
                        <div className="p-5 md:p-6 flex flex-col flex-1 bg-sand-primary">
                            <h3 className="serif-title text-lg md:text-xl mb-2 text-charcoal-main">Sidpa Bardo</h3>
                            <p className="text-charcoal-muted text-xs leading-relaxed mb-4 md:mb-6 flex-1 font-serif line-clamp-2 md:line-clamp-none">
