        ...
        <AnimatePresence>
            {isOpen && album && (
                <>
                    ...
                    >
                        {/* Header Image Area */}
                        <div className="relative pt-10 pb-6 md:pt-14 md:pb-8 shrink-0 bg-sand-secondary border-b border-sand-tertiary">
                            <div
                            ...
                            <button
                                onClick={onClose}
                                className="absolute top-4 right-4 md:top-6 md:right-6 w-10 h-10 rounded-full bg-sand-primary/80 backdrop-blur-md flex items-center justify-center text-charcoal-main hover:bg-gold-primary hover:text-white transition-colors duration-300 z-10 border border-sand-tertiary shadow-sm"
                            >
                                <X size={20} />
                            </button>
                            ...
                            <div className="relative z-10 px-6 md:px-12 max-w-5xl mx-auto flex flex-col sm:flex-row items-center sm:items-end gap-6 md:gap-8">
                                <div className="w-28 h-28 md:w-36 md:h-36 bg-gradient-to-br from-charcoal-main to-gold-primary/10 shadow-[0_5px_15px_rgba(0,0,0,0.1)] border border-sand-tertiary flex flex-col items-center justify-center shrink-0 overflow-hidden rounded-md">
                                    {album.coverImage ? (
                                ...
                                <div className="space-y-2 md:space-y-3 text-center sm:text-left pb-1 md:pb-2 flex-1">
                                    <p className="text-gold-primary text-[9px] md:text-[10px] tracking-[0.4em] uppercase font-bold">
                                        {album.artist || "Traditional"}
                                    </p>
                                    <h2 className="serif-title text-2xl sm:text-3xl md:text-3xl lg:text-4xl text-charcoal-main leading-[1.1] tracking-wide">
                                        {album.title}
                                    </h2>
                                </div>
                            </div>
                        ...
                        {/* Tracklist Area */}
                        <div className="flex-1 overflow-y-auto px-6 md:px-12 py-6 md:py-8 pb-48 md:pb-32">
                            <div className="max-w-3xl mx-auto space-y-6 md:space-y-8">
                                <p className="text-charcoal-main/90 md:text-md font-sans font-medium leading-[1.8] tracking-[0.02em] whitespace-pre-line border-l-2 border-gold-primary/40 pl-5 md:pl-6 text-sm">
                                    {album.description}
                                </p>

                                <div className="space-y-1 pt-4 md:pt-6 border-t border-gold-primary/10">
