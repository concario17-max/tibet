            ...
            {korean ? (
                <div className="rounded-[1.8rem] border border-gold-border/18 bg-gradient-to-b from-sand-primary/75 to-white/60 px-5 py-6 shadow-[0_20px_50px_rgba(120,93,48,0.06)] backdrop-blur-lg dark:border-dark-border/55 dark:from-dark-surface/45 dark:to-dark-bg/35 sm:px-8 sm:py-8">
                    ...
                    {Array.isArray(korean) ? (
                        <div className="mt-5 space-y-8 sm:space-y-10">
                            {korean.map((entry, index) => (
                                <div key={`${entry.translator}-${index}`} className="relative">
                                    ...
                                    <p className="mt-3 break-keep font-korean text-[16px] leading-[2] tracking-[-0.01em] text-text-primary dark:text-dark-text-primary sm:text-[18px] sm:leading-[2.1]">
                                        {entry.text.replace(/[\r\n]+/g, ' ')}
                                    </p>
                                </div>
                            ))}
                        ...
                        <p className="mt-4 break-keep font-korean text-[16px] leading-[2] tracking-[-0.01em] text-text-primary dark:text-dark-text-primary sm:text-[18px] sm:leading-[2.1]">
